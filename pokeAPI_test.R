...
par(mar=c(7,3,3,0))
mtext(side=3, line=0.5, "Count of Pokemon by Habitat", col="blue", font=3, cex=2)
mtext(side=3, line=4.5, "Habitat", col="red", font=2,cex=1.2)
mtext(side=2, line=2, "Count of Pokemons", col="red", font=2, cex=1.2)

barplot(habitatSummary$meanCaptureRate, names.arg=habitatSummary$habitat, las=2,col="#FFCC33")
par(mar=c(7,3,3,0))
mtext(side=3, line=0.5, "Mean Capture Rate by Habitat", col="blue", font=3, cex=2)
mtext(side=1, line=4.5, "Habitat", col="red", font=2,cex=1.2)
...
par(mar=c(7,3,3,0))
mtext(side=3, line=0.5, "Count of Pokemon by Type", col="blue", font=3, cex=2)
